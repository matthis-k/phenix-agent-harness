...
An objective that requests full repository QA, deterministic checks, test execution, or validation matches workflow.qa when it is offered. An objective that requires repository mutation matches workflow.implement when it is offered.
