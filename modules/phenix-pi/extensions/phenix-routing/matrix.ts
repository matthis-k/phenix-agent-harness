...
type MutableRoleMatrix = Partial<
  Record<RoutingRole, Partial<Record<Difficulty, RoleRoute>>>
>;
 ...
 */
function buildRoleMatrix(): Readonly<
...
export function allMatrixKeys(): Array<{ role: RoutingRole; difficulty: Difficulty }> {
  return ROUTING_ROLES.flatMap((role) =>
