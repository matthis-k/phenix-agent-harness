...
import type { LinkDiagnostic } from "@matthis-k/phenix-kernel/diagnostics.ts";
import type {
  AgentClientId,
  CapabilityId,
...
import { capabilityId, modelSetId } from "@matthis-k/phenix-kernel/ids.ts";
import type { Difficulty } from "@matthis-k/phenix-kernel/task.ts";
import { ALL_DIFFICULTIES } from "@matthis-k/phenix-kernel/task.ts";
