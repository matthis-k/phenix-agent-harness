...
| `implement` | `invoke` | `implementer` | `required` | `any` | Implement {objective}. Treat input.plan as authoritative when present; otherwise use states.plan.output. Do not re-plan. | `verify` |
